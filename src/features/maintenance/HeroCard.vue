...
<template>
  <div
    class="relative flex max-w-[197px] h-[174px] md:min-h-[375px] md:max-w-[378px] lg:max-w-[514px] rounded-sm bg-amBluePremium text-white shadow-2xl"
  >
    <div
      class="flex flex-col justify-between px-5 md:px-0 md:pl-[34px] py-2.5 md:py-5 md:pr-2 lg:pr-0"
    >
      <div>
        <h2
      ...
      <BaseButton
        class="hidden md:hidden lg:inline-flex lg:self-start"
        variant="primary"
        size="lg"
